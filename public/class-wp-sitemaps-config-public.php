...
if ( ! class_exists( 'WP_Sitemaps_Config_Public' ) ) {
	class WP_Sitemaps_Config_Public {
		 ...
		 */
		public function is_sitemaps_enabled (): bool {
		 ...
		 * @since    1.0.0
		 */
		public function change_sitemaps_post_types( array $post_types ): array {
		 ...
		 * @since    1.0.0
		 */
		public function change_sitemaps_taxonomies( array $taxonomies ): array {
		 ...
		 * @since    1.0.0
		 */
		public function change_sitemaps_posts_entry ( $entry, WP_Post $post ): array {
		 ...
		 * @updated 2.0.4
		 */
		public function exclude_single_posts( array $args, string $post_type ): array {
