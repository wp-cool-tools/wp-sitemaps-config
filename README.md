...
* German/Germany (de_DE_formal)
* Spanish (Spain) 
* Spanish (Mexico)
* Spanish (Venezuela)

POT file with text strings is included. If you would like to add a translation and see your name here, please [get in touch](mailto:support@kybernetik.com.de).
